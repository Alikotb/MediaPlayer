package com.audio.tunoo.mediaplayer.features.favorite
...
import com.audio.tunoo.mediaplayer.databinding.FragmentFavoriteBinding
                    ...
                    is Response.Success<*> -> {
                        ...
                        binding?.favRecyclerView?.adapter = TracksAdapter(
                            ...
                            state.data as List<AudioDto>, onAudioItemClick = {
                                navigateToAudioPlayer(obj = it, state.data as List<AudioDto>)
                            })
                        return@collect
                    }
